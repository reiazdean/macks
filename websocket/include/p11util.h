...
private:
	...
	static       CK_RV                         getObjectAttribute(CK_SESSION_HANDLE hSession,
...
public:
	...
	static       CK_RV                         getCertificate(CK_BYTE_PTR pLabel,
                                                              CK_ULONG ulLabLen,
                                                              CK_ULONG &ulCertLen,
                                                              CK_BYTE_PTR &pByte);

	static       CK_RV                         getPublicKey(CK_BYTE_PTR pLabel,
                                                            CK_ULONG ulLabLen,
                                                            CK_ULONG &ulPubLen,
                                                            CK_BYTE_PTR &pByte);

	static       CK_RV                         sign(CK_BYTE_PTR pLabel,
                                                    CK_ULONG ulLabLen,
